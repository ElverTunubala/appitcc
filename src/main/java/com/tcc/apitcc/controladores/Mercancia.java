...
public class Mercancia {
    ...
    private String minicipioRemitente;
    ...
    private String departamentoDestinatarrio;
    ...
    public String getMinicipioRemitente() {
        return minicipioRemitente;
    }

    public void setMinicipioRemitente(String minicipioRemitente) {
        this.minicipioRemitente = minicipioRemitente;
    }
    ...
    public String getDepartamentoDestinatarrio() {
        return departamentoDestinatarrio;
    }

    public void setDepartamentoDestinatarrio(String departamentoDestinatarrio) {
        this.departamentoDestinatarrio = departamentoDestinatarrio;
    }
